...
. Back in the partition screen, select *Finish partitioning and write changes to the disks*. For big disks, it may take some time to create the ext4 file systems.
