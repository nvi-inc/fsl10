...
If not already set correctly, set the file's permissions and ownership for *oper* (analogously for *prog*) with:
...
usermod -L spare
----
#TODO: It may be necessary to disable password update policies for thw operation computer *spare*  account to avoid *ssh* being locked out#
