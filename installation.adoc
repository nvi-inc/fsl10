...
where _tag_ is the latest available release, be it 10.0.0 or
later.

[IMPORTANT]
====

Although 10.0.0 is the current release at the time this was written,
...
ending *.0*) for the most recent feature release, you should use the
most recent patch release.  For example, if *10.1.0* is the most
recent feature release and there are corresponding patch releases,
*10.1.1* and *10.1.2*, the last one, ending *.2*, is probably the best
choice.
