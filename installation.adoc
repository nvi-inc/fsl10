...
were _tag_ is the latest available release, be it the 10.0.0-beta2 pre-release
(as at the time of writing), 10.0.0-rc1, 10.0.0 or later.

[IMPORTANT]
====

Although 10.0.0 is the most recent release envisaged at the time this was
written and should suffice for an initial installation, it may well not
be the most up-to-date release. To find more recent releases, go to:
