...
used for further redundancy. You can of course provide our own back-up
system and can install the system to a single disk if you do not want
to use the software RAID.
