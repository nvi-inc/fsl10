...
To make sure the *tally2* failure count is reset after a successful
*sudo* that required a passowd, add to:
...
Otherwise the *tally2*  grows almost without bound for every *sudo*.
