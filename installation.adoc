...
To make sure the *tally2* failure count is reset after a successful *sudo*, add to:
...
user *oper* but it works analogously for *prog* and *root*, see the note at the end of step (1( about *root*'s Xresources):
