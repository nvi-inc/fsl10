...
These instructions provide a complete method for the system installation and
some tuning. They are not the only method for accomplishing these goals, but
have been well tested. Experts can of course use their own means, but the
farther they deviate from this model, the less likely we be able to support
them.
+
.FSL distributions
|=============================================================
| FS Linux |Release Name| Base Distro. | Kernel vers. | Year

|    1     |            | Slackware    | Linux 1.2.x  | 1994
|    2     |"bo"        | Debian 1.3.1 | Linux 2.0.29 | 1997
|    3     |"hamm"      | Debian 2.0   | Linux 2.0.34 | 1998
|          |"slink"     | Debian 2.1   | Linux 2.0.36 | 1999
|    4     |"potato"    | Debian 2.2   | Linux 2.2.18 | 2000
|    5     |"woody"     | Debian 3.0   | Linux 2.2.20 | 2002
|    6     |"sarge"     | Debian 3.1   | Linux 2.4.27 | 2005
|    7     |"etch"      | Debian 4.0   | Linux 2.6.18 | 2007
|    8     |"lenny"     | Debian 5.0   | Linux 2.6.26 | 2009
|          |"squeeze"   | Debian 6.0   | Linux 2.6.32 | 2011
|    9     |"wheezy"    | Debian 7.0   | Linux 3.2.0  | 2013
|          |"jessie"    | Debian 8.0   | Linux 3.16.0 | 2015
|   10     |"stretch"   | Debian 9.0   | Linux 4.9.0  | 2017
|          |"buster"    | Debian 10.0  | Linux 4.19.0 | 2019
|=============================================================
...
most recent release available at the time this was written. That
should work for an initial installation, but may not give you the most
up-to-date release. To find more recent releases, go to:

https://github.com/nvi-inc/fs/releases

You should use the most recent release with no trailing *-_string_*,
e.g., *10.0.0*, except that *10.0.0-beta* versions should be useful
for beta testing.

NOTE: Releases before *10.0.0-beta1* are listed mostly for historical
reference. They are not expected to be work for 64-bit systems and
may need some adjustments for full functionality on 32-bit systems.

Once you locate the release you want, you should use it in place of
*10.0.0-beta1* at the end of the *git checkout* command below.
