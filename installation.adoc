...
NOTE: Since _Stretch_ is no longer under security support, you will
also need to modify _sources.list_ as described in the
<<End of security updates>> in the <<Managing Security Updates>>
appendix.
...
If you installed the RAID with two disks (and RAID tools) check its
progress with:
...
IMPORTANT: Do not reboot until the recovery is complete.
