...
|5 |/var           | var*     | 8 G
|6 |/var/log       | log*     | 4 G
|7 |/var/log/audit | audit*   | 500 M
|8 |/home          | home     | 4 G
|9 |/usr2          | usr2     | remaining disk space *less about 50 GB* (you don't need to be precise, this is just useful if you need to resize a logical volume later)
|=======================================
...
In the fs10 directory, start FSADAPT with
