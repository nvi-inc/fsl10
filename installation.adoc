...
NOTE: If some other file system, like *xfs*, or an old setup is
displayed, you may need to use *Guided partitioning* to create new
partitions, then switch back to *Manual* to delete them. This should
get you back to just *FREE SPACE*.
