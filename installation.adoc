...
LVM, which you must do to continue. Then switch back to *Manual* and
select the target disk again.  That should get you back to a disk
partition layout that you can delete using the instructions above.
...
. Enter a name appropriate for the machine and group, eg *lv*, and press kbd:[Enter]
