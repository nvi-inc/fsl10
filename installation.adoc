...
displayed, you may need to use *Guided partitoning* to create new
partitions, then delete them. This should get you back to *FREE
SPACE*.
...
Boot with new secondary disk keyed off or removed. This will ensure the machine is booted from the good disk.
