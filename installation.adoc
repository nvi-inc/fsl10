...
for this partition instead and skip ahead to <<Setru Logial Volume Manager (LVM)>> below.
However, plese note that a single disk setup is not recommended for any *operational* system.
