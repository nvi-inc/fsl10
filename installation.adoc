...
currently covered. If you have the listed hardware, we recommend
reading the instructions before beginning the installation.

.Special installation instructions available
|=============================================================
| Sub-directory | Hardware

| https://github.com/nvi-inc/fsl10/tree/master/X11SCA-F[X11SCA-F] | Supermicro X11SCA-F motherboard
|=============================================================
