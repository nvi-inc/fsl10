...
If you are testing a kernel update, you must take extra steps
...
If you are testing a kernel update, you must turn on the disk
...
If you are testing a kernel update, you must reboot after the
